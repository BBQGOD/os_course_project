...
def handle(event, context):
    ...
    text_generator, tokenizer, model, redis_client = prep("function/hf_gpt2")
    ...
    if event.method == "GET":
        ...
        m_length = int(json_data["max_length"])
        ...
        # check in redis
            ...
            res = model.generate(
                ...
                max_length=m_length - len(prefix) - input_ids.shape[1] + 1,
                do_sample=True,
                temperature=0.7,
            )
            ...
            res = model.generate(
                ...
                past_key_values=past_key_values,
                max_length=m_length - input_ids.shape[1] + 1,
                do_sample=True,
                temperature=0.7,
            )
            gen_res = tokenizer.batch_decode(res, skip_special_tokens=True)
